...
def main(argv=None):
    ...
    parser.add_argument("--staging", default=False, action="store_true", help="use Let's Encrypt staging directory")

    args = parser.parse_args(argv)
    LOGGER.setLevel(args.quiet or LOGGER.level)
    signed_crt = get_crt(args.account_key, 
            args.csr,
            args.acme_dir,
            log=LOGGER,
            CA=args.ca,
            disable_check=args.disable_check,
            directory_url=STAGING_DIRECTORY_URL if (args.staging) else args.directory_url,
